...
play_img = PhotoImage(file="Bg/1play.png")
back_img = PhotoImage(file="Bg/2back.png")
pause_img = PhotoImage(file="Bg/3pause.png")
forward_img = PhotoImage(file="Bg/4forward.png")
shuffle_img = PhotoImage(file="Bg/5shuffle.png")
